...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Excellence in Computing</span> <span className="text-primary/60">✦</span>
    <span>Innovation Hub</span> <span className="text-secondary/60">✦</span>
    <span>student empowerment</span> <span className="text-primary/60">✦</span>
    <span>Tech Leadership</span> <span className="text-secondary/60">✦</span>
    <span>Future Ready</span> <span className="text-primary/60">✦</span>
  </div>
);
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton as="a" href="https://www.facebook.com/PUPASCII/" target="_blank" className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                ...
                <MagneticButton as="a" href="/events" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  Events
                </MagneticButton>
                <MagneticButton as="a" href="/contacts" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  Contacts
                </MagneticButton>
              </div>
            </div>
