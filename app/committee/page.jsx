...
const docusecmembers = [
  // docusec members
  { role: "Documentation & Secretariat", name: "Aviles, Joan Kathleen E."},
  { role: "Documentation & Secretariat", name: "Bhasa, Rein Cherztin G."},
  { role: "Documentation & Secretariat", name: "Buenaventura, Harvey L."},
  { role: "Documentation & Secretariat", name: "Cagadas, Marielle I."},
  { role: "Documentation & Secretariat", name: "Cereno, Rjay B."},
  { role: "Documentation & Secretariat", name: "Dela Paz, Bien Jeric"},
  { role: "Documentation & Secretariat", name: "Edrosa, Jwin Yael D."},
  { role: "Documentation & Secretariat", name: "Espiritu, Anthea Lyn Czeisler P."},
  { role: "Documentation & Secretariat", name: "Jimena, Andrea Shane B."},
  { role: "Documentation & Secretariat", name: "Liwag, John Eric T."},
  { role: "Documentation & Secretariat", name: "Lorenzana, Ma. Kristel Anne D."},
  { role: "Documentation & Secretariat", name: "Matinong, Arwen Therese Emmanuelle C."},
  { role: "Documentation & Secretariat", name: "Naperi, Hans Ezekiel M."},
  { role: "Documentation & Secretariat", name: "Rapada, Gian Kyle D."},
  { role: "Documentation & Secretariat", name: "Reboquio, Carl Gian, D."},
  { role: "Documentation & Secretariat", name: "Remolacio, Alexandra Geane M."},
  { role: "Documentation & Secretariat", name: "Samson, Lander D."},
  { role: "Documentation & Secretariat", name: "Torio, Sam Althea Nicole S."},
  { role: "Documentation & Secretariat", name: "Valderama, Gabriel V."},
  { role: "Documentation & Secretariat", name: "Bhasa, Rein Cherztin G."},
]
